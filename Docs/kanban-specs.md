...
**Status:** Shipped (2026-05-06, v0.3.11 — response-strengthening pass: every kanban tool response and Coach-bound event payload now ends with an imperative "what's next" line).
