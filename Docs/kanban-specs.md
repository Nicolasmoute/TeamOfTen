...
**Status:** Shipped (2026-05-05, v0.3.9.1 — three audit fixes on v0.3.9: wake-body Telegram-routing accuracy, no-op transition short-circuit, publish/wake exception isolation).
