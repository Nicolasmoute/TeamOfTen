...
def test_docs_describe_text_and_message_sent_reply_paths() -> None:
    frontend_docs = (ROOT / "Docs/tot-specs-16-frontend-specification.md").read_text()
    reply_docs = (ROOT / "Docs/reply-affordance.md").read_text()
    normalized = " ".join((frontend_docs + "\n" + reply_docs).split())
